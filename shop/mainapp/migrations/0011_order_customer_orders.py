# Generated by Django 4.0 on 2022-02-18 18:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0010_alter_customer_address_alter_customer_phone'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=tkinter.tix.Tree, max_length=1024, null=True, verbose_name='Адрес')),
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в оброботке'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=100, verbose_name='Статус Заказ')),
